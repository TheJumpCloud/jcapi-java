...
# **directoriesList**
> List&lt;Directory&gt; directoriesList(contentType, accept, fields, limit, skip, sort)
...
try {
    List<Directory> result = apiInstance.directoriesList(contentType, accept, fields, limit, skip, sort);
