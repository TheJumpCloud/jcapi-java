...
/**
 * API tests for PolicyGroupMembersMembershipApi
 */
@Ignore
public class PolicyGroupMembersMembershipApiTest {

    private final PolicyGroupMembersMembershipApi api = new PolicyGroupMembersMembershipApi();
