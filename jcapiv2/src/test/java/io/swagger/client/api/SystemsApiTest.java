...
public class SystemsApiTest {
     ...
     */
    @Test
    public void systemsGetFDEKeyTest() throws Exception {
        String systemId = null;
        String xOrgId = null;
     ...
     */
    @Test
    public void systemsListSoftwareAppsWithStatusesTest() throws Exception {
        String systemId = null;
        String xOrgId = null;
        List<String> filter = null;
        Integer limit = null;
        Integer skip = null;
        List<String> sort = null;
        List<SoftwareAppWithStatus> response = api.systemsListSoftwareAppsWithStatuses(systemId, xOrgId, filter, limit, skip, sort);
