...
/**
 * API tests for IpListsApi
 */
@Ignore
public class IpListsApiTest {

    private final IpListsApi api = new IpListsApi();
     ...
     */
    @Test
    public void iplistsDeleteTest() throws Exception {
        String id = null;
        String xOrgId = null;
        IPList response = api.iplistsDelete(id, xOrgId);
     ...
     */
    @Test
    public void iplistsGetTest() throws Exception {
        String id = null;
        String xOrgId = null;
        IPList response = api.iplistsGet(id, xOrgId);
     ...
     */
    @Test
    public void iplistsListTest() throws Exception {
        String xOrgId = null;
        ...
        List<IPList> response = api.iplistsList(xOrgId, xTotalCount, limit, skip, filter, sort);
     ...
     */
    @Test
    public void iplistsPatchTest() throws Exception {
        String id = null;
        IPListRequest body = null;
        String xOrgId = null;
        IPList response = api.iplistsPatch(id, body, xOrgId);
     ...
     */
    @Test
    public void iplistsPostTest() throws Exception {
        IPListRequest body = null;
        String xOrgId = null;
        IPList response = api.iplistsPost(body, xOrgId);
     ...
     */
    @Test
    public void iplistsPutTest() throws Exception {
        String id = null;
        IPListRequest body = null;
        String xOrgId = null;
        IPList response = api.iplistsPut(id, body, xOrgId);
