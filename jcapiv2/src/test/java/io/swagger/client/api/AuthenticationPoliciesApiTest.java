...
/**
 * API tests for AuthenticationPoliciesApi
 */
@Ignore
public class AuthenticationPoliciesApiTest {

    private final AuthenticationPoliciesApi api = new AuthenticationPoliciesApi();
     ...
     */
    @Test
    public void authnpoliciesDeleteTest() throws Exception {
        String id = null;
        String xOrgId = null;
        AuthnPolicy response = api.authnpoliciesDelete(id, xOrgId);
     ...
     */
    @Test
    public void authnpoliciesGetTest() throws Exception {
        String id = null;
        String xOrgId = null;
        AuthnPolicy response = api.authnpoliciesGet(id, xOrgId);
     ...
     */
    @Test
    public void authnpoliciesListTest() throws Exception {
        String xOrgId = null;
        ...
        List<AuthnPolicy> response = api.authnpoliciesList(xOrgId, xTotalCount, limit, skip, filter, sort);
     ...
     */
    @Test
    public void authnpoliciesPatchTest() throws Exception {
        String id = null;
        AuthnPolicyInput body = null;
        String xOrgId = null;
        AuthnPolicy response = api.authnpoliciesPatch(id, body, xOrgId);
     ...
     */
    @Test
    public void authnpoliciesPostTest() throws Exception {
        AuthnPolicyInput body = null;
        String xOrgId = null;
        AuthnPolicy response = api.authnpoliciesPost(body, xOrgId);
