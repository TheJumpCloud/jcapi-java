...
public class CommandsApiTest {
     ...
     */
    @Test
    public void commandsCancelQueuedCommandsByWorkflowInstanceIdTest() throws Exception {
        String workflowInstanceId = null;
        String xOrgId = null;
        api.commandsCancelQueuedCommandsByWorkflowInstanceId(workflowInstanceId, xOrgId);
     ...
     */
    @Test
    public void commandsGetQueuedCommandsByWorkflowTest() throws Exception {
        String xOrgId = null;
        Integer limit = null;
        List<String> filter = null;
        Integer skip = null;
        QueuedCommandList response = api.commandsGetQueuedCommandsByWorkflow(xOrgId, limit, filter, skip);
