...
public class ApplicationsApiTest {
     ...
     */
    @Test
    public void applicationsDeleteLogoTest() throws Exception {
        String applicationId = null;
        String xOrgId = null;
        api.applicationsDeleteLogo(applicationId, xOrgId);
    ...
    public void applicationsGetTest() throws Exception {
        String applicationId = null;
        String xOrgId = null;
        Object response = api.applicationsGet(applicationId, xOrgId);
     ...
     */
    @Test
    public void applicationsPostLogoTest() throws Exception {
        String applicationId = null;
        File image = null;
        String xOrgId = null;
        api.applicationsPostLogo(applicationId, image, xOrgId);
    ...
    public void importUsersTest() throws Exception {
        ...
        Integer limit = null;
        Integer skip = null;
        ImportUsersResponse response = api.importUsers(applicationId, filter, query, sort, sortOrder, xOrgId, limit, skip);
