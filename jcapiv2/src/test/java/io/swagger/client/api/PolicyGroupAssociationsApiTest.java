...
/**
 * API tests for PolicyGroupAssociationsApi
 */
@Ignore
public class PolicyGroupAssociationsApiTest {

    private final PolicyGroupAssociationsApi api = new PolicyGroupAssociationsApi();
