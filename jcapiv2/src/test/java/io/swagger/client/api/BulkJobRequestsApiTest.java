...
public class BulkJobRequestsApiTest {
     ...
     */
    @Test
    public void bulkUserStatesCreateTest() throws Exception {
        BulkScheduledStatechangeCreate body = null;
        String xOrgId = null;
        List<ScheduledUserstateResult> response = api.bulkUserStatesCreate(body, xOrgId);
     ...
     */
    @Test
    public void bulkUserStatesDeleteTest() throws Exception {
        String id = null;
        String xOrgId = null;
        api.bulkUserStatesDelete(id, xOrgId);
     ...
     */
    @Test
    public void bulkUserStatesGetNextScheduledTest() throws Exception {
        List<String> users = null;
        Integer limit = null;
        Integer skip = null;
        InlineResponse200 response = api.bulkUserStatesGetNextScheduled(users, limit, skip);
     ...
     */
    @Test
    public void bulkUserStatesListTest() throws Exception {
        Integer limit = null;
        List<String> filter = null;
        Integer skip = null;
        String xOrgId = null;
        String userid = null;
        List<ScheduledUserstateResult> response = api.bulkUserStatesList(limit, filter, skip, xOrgId, userid);
     ...
     */
    @Test
    public void bulkUsersCreateTest() throws Exception {
        List<BulkUserCreate> body = null;
        String xOrgId = null;
        String creationSource = null;
        JobId response = api.bulkUsersCreate(body, xOrgId, creationSource);
     ...
     */
    @Test
    public void bulkUsersCreateResultsTest() throws Exception {
        String jobId = null;
        Integer limit = null;
        Integer skip = null;
        String xOrgId = null;
        List<JobWorkresult> response = api.bulkUsersCreateResults(jobId, limit, skip, xOrgId);
     ...
     */
    @Test
    public void bulkUsersUpdateTest() throws Exception {
        List<BulkUserUpdate> body = null;
        String xOrgId = null;
        JobId response = api.bulkUsersUpdate(body, xOrgId);
