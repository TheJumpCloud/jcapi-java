...
public class SystemGroupsApiTest {
     ...
     */
    @Test
    public void groupsSystemDeleteTest() throws Exception {
        String id = null;
        String xOrgId = null;
        SystemGroup response = api.groupsSystemDelete(id, xOrgId);
     ...
     */
    @Test
    public void groupsSystemGetTest() throws Exception {
        String id = null;
        String xOrgId = null;
        SystemGroup response = api.groupsSystemGet(id, xOrgId);
     ...
     */
    @Test
    public void groupsSystemListTest() throws Exception {
        ...
        List<String> sort = null;
        String xOrgId = null;
        List<SystemGroup> response = api.groupsSystemList(fields, filter, limit, skip, sort, xOrgId);
     ...
     */
    @Test
    public void groupsSystemPostTest() throws Exception {
        SystemGroupData body = null;
        String xOrgId = null;
        SystemGroup response = api.groupsSystemPost(body, xOrgId);
     ...
     */
    @Test
    public void groupsSystemPutTest() throws Exception {
        String id = null;
        SystemGroupData body = null;
        String xOrgId = null;
        SystemGroup response = api.groupsSystemPut(id, body, xOrgId);
