...
public class LdapServersApiTest {
     ...
     */
    @Test
    public void ldapserversGetTest() throws Exception {
        String id = null;
        String xOrgId = null;
        LdapServerOutput response = api.ldapserversGet(id, xOrgId);
     ...
     */
    @Test
    public void ldapserversListTest() throws Exception {
        ...
        String xOrgId = null;
        List<LdapServerOutput> response = api.ldapserversList(fields, filter, limit, skip, sort, xOrgId);
     ...
     */
    @Test
    public void ldapserversPatchTest() throws Exception {
        String id = null;
        LdapserversIdBody body = null;
        String xOrgId = null;
        InlineResponse20010 response = api.ldapserversPatch(id, body, xOrgId);
