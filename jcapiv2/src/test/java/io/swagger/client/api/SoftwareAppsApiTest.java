...
public class SoftwareAppsApiTest {
    ...
    private final SoftwareAppsApi api = new SoftwareAppsApi();
     ...
     */
    @Test
    public void softwareAppStatusesListTest() throws Exception {
        String softwareAppId = null;
        String xOrgId = null;
        List<String> filter = null;
        Integer limit = null;
        ...
        List<SoftwareAppStatus> response = api.softwareAppStatusesList(softwareAppId, xOrgId, filter, limit, skip, sort);
     ...
     */
    @Test
    public void softwareAppsDeleteTest() throws Exception {
        String id = null;
        String xOrgId = null;
        api.softwareAppsDelete(id, xOrgId);
     ...
     */
    @Test
    public void softwareAppsGetTest() throws Exception {
        String id = null;
        String xOrgId = null;
        SoftwareApp response = api.softwareAppsGet(id, xOrgId);
     ...
     */
    @Test
    public void softwareAppsListTest() throws Exception {
        String xOrgId = null;
        List<String> filter = null;
        Integer limit = null;
        Integer skip = null;
        List<String> sort = null;
        List<SoftwareApp> response = api.softwareAppsList(xOrgId, filter, limit, skip, sort);
     ...
     */
    @Test
    public void softwareAppsPostTest() throws Exception {
        SoftwareApp body = null;
        String xOrgId = null;
        SoftwareApp response = api.softwareAppsPost(body, xOrgId);
     ...
     */
    @Test
    public void softwareAppsReclaimLicensesTest() throws Exception {
        String softwareAppId = null;
        SoftwareAppReclaimLicenses response = api.softwareAppsReclaimLicenses(softwareAppId);
     ...
     */
    @Test
    public void softwareAppsRetryInstallationTest() throws Exception {
        SoftwareAppsRetryInstallationRequest body = null;
        String softwareAppId = null;
        api.softwareAppsRetryInstallation(body, softwareAppId);
     ...
     */
    @Test
    public void softwareAppsUpdateTest() throws Exception {
        String id = null;
        SoftwareApp body = null;
        String xOrgId = null;
        SoftwareApp response = api.softwareAppsUpdate(id, body, xOrgId);
