...
public class ActiveDirectoryApiTest {
     ...
     */
    @Test
    public void activedirectoriesAgentsDeleteTest() throws Exception {
        String activedirectoryId = null;
        String agentId = null;
        String xOrgId = null;
        api.activedirectoriesAgentsDelete(activedirectoryId, agentId, xOrgId);
     ...
     */
    @Test
    public void activedirectoriesAgentsGetTest() throws Exception {
        String activedirectoryId = null;
        String agentId = null;
        String xOrgId = null;
        ActiveDirectoryAgentListOutput response = api.activedirectoriesAgentsGet(activedirectoryId, agentId, xOrgId);
     ...
     */
    @Test
    public void activedirectoriesAgentsListTest() throws Exception {
        String activedirectoryId = null;
        Integer limit = null;
        Integer skip = null;
        List<String> sort = null;
        String xOrgId = null;
        List<ActiveDirectoryAgentListOutput> response = api.activedirectoriesAgentsList(activedirectoryId, limit, skip, sort, xOrgId);
     ...
     */
    @Test
    public void activedirectoriesAgentsPostTest() throws Exception {
        String activedirectoryId = null;
        ActiveDirectoryAgentInput body = null;
        String xOrgId = null;
        ActiveDirectoryAgentGetOutput response = api.activedirectoriesAgentsPost(activedirectoryId, body, xOrgId);
     ...
     */
    @Test
    public void activedirectoriesDeleteTest() throws Exception {
        String id = null;
        String xOrgId = null;
        ActiveDirectoryOutput response = api.activedirectoriesDelete(id, xOrgId);
     ...
     */
    @Test
    public void activedirectoriesGetTest() throws Exception {
        String id = null;
        String xOrgId = null;
        ActiveDirectoryOutput response = api.activedirectoriesGet(id, xOrgId);
     ...
     */
    @Test
    public void activedirectoriesListTest() throws Exception {
        ...
        List<String> sort = null;
        String xOrgId = null;
        List<ActiveDirectoryOutput> response = api.activedirectoriesList(fields, filter, limit, skip, sort, xOrgId);
     ...
     */
    @Test
    public void activedirectoriesPostTest() throws Exception {
        ActiveDirectoryInput body = null;
        String xOrgId = null;
        ActiveDirectoryOutput response = api.activedirectoriesPost(body, xOrgId);
