...
/**
 * API tests for PolicyGroupsApi
 */
@Ignore
public class PolicyGroupsApiTest {

    private final PolicyGroupsApi api = new PolicyGroupsApi();
     ...
     */
    @Test
    public void groupsPolicyDeleteTest() throws Exception {
        String id = null;
        String xOrgId = null;
        PolicyGroup response = api.groupsPolicyDelete(id, xOrgId);
     ...
     */
    @Test
    public void groupsPolicyGetTest() throws Exception {
        String id = null;
        String xOrgId = null;
        PolicyGroup response = api.groupsPolicyGet(id, xOrgId);
     ...
     */
    @Test
    public void groupsPolicyListTest() throws Exception {
        ...
        List<String> sort = null;
        String xOrgId = null;
        List<PolicyGroup> response = api.groupsPolicyList(fields, filter, limit, skip, sort, xOrgId);
     ...
     */
    @Test
    public void groupsPolicyPostTest() throws Exception {
        PolicyGroupData body = null;
        String xOrgId = null;
        PolicyGroup response = api.groupsPolicyPost(body, xOrgId);
     ...
     */
    @Test
    public void groupsPolicyPutTest() throws Exception {
        String id = null;
        PolicyGroupData body = null;
        String xOrgId = null;
        PolicyGroup response = api.groupsPolicyPut(id, body, xOrgId);
