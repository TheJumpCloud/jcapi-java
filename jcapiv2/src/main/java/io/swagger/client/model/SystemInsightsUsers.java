...
public class SystemInsightsUsers {
  @SerializedName("ad_managed")
  private Boolean adManaged = null;
  ...
  public SystemInsightsUsers adManaged(Boolean adManaged) {
   ...
   * @return adManaged
  **/
  @Schema(description = "Indicates this account belongs to a AD-managed user")
  public Boolean isAdManaged() {
    return adManaged;
  }

  public void setAdManaged(Boolean adManaged) {
    this.adManaged = adManaged;
  }

  public SystemInsightsUsers admin(Boolean admin) {
    this.admin = admin;
    return this;
  }
   ...
   * @return admin
  **/
  @Schema(description = "Indicates this account has local administrator privileges")
  ...
  **/
  ...
  public SystemInsightsUsers lastLogin(String lastLogin) {
   ...
   * @return lastLogin
  **/
  @Schema(description = "A Unix timestamp showing the last time this user logged in")
  ...
  public SystemInsightsUsers managed(Boolean managed) {
   ...
   * @return managed
  **/
  @Schema(description = "Indicates this account belongs to a JumpCloud-managed user")
  ...
  public SystemInsightsUsers realUser(Boolean realUser) {
   ...
   * @return realUser
  **/
  @Schema(description = "Indicates this account represents an interactive user account vs. a system or daemon account")
  ...
  **/
  ...
  public SystemInsightsUsers suspended(Boolean suspended) {
   ...
   * @return suspended
  **/
  @Schema(description = "Indicates this account is suspended or locked out")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.adManaged, systemInsightsUsers.adManaged) &&
        Objects.equals(this.admin, systemInsightsUsers.admin) &&
        Objects.equals(this.collectionTime, systemInsightsUsers.collectionTime) &&
        ...
        Objects.equals(this.lastLogin, systemInsightsUsers.lastLogin) &&
        Objects.equals(this.managed, systemInsightsUsers.managed) &&
        Objects.equals(this.realUser, systemInsightsUsers.realUser) &&
        Objects.equals(this.shell, systemInsightsUsers.shell) &&
        Objects.equals(this.suspended, systemInsightsUsers.suspended) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(adManaged, admin, collectionTime, description, directory, gid, gidSigned, lastLogin, managed, realUser, shell, suspended, systemId, type, uid, uidSigned, username, uuid);
  }
  ...
  public String toString() {
    ...
    sb.append("    adManaged: ").append(toIndentedString(adManaged)).append("\n");
