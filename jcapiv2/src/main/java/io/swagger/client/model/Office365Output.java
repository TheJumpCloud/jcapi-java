...
public class Office365Output {
  @SerializedName("groupsEnabled")
  private Boolean groupsEnabled = null;
  ...
  public enum UserLockoutActionEnum {
    ...
    public static UserLockoutActionEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<UserLockoutActionEnum> {
      ...
      public UserLockoutActionEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return UserLockoutActionEnum.fromValue((String)(value));
      }
    }
  ...
  public enum UserPasswordExpirationActionEnum {
    ...
    public static UserPasswordExpirationActionEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<UserPasswordExpirationActionEnum> {
      ...
      public UserPasswordExpirationActionEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return UserPasswordExpirationActionEnum.fromValue((String)(value));
      }
    }
  }  @SerializedName("userPasswordExpirationAction")
  private UserPasswordExpirationActionEnum userPasswordExpirationAction = null;

  public Office365Output groupsEnabled(Boolean groupsEnabled) {
  ...
  **/
  ...
  public Office365Output id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public Office365Output name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public Office365Output userLockoutAction(UserLockoutActionEnum userLockoutAction) {
  ...
  **/
  ...
  public Office365Output userPasswordExpirationAction(UserPasswordExpirationActionEnum userPasswordExpirationAction) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Office365Output office365Output = (Office365Output) o;
    return Objects.equals(this.groupsEnabled, office365Output.groupsEnabled) &&
        Objects.equals(this.id, office365Output.id) &&
        Objects.equals(this.name, office365Output.name) &&
        Objects.equals(this.userLockoutAction, office365Output.userLockoutAction) &&
        Objects.equals(this.userPasswordExpirationAction, office365Output.userPasswordExpirationAction);
  }

  @Override
  public int hashCode() {
    return Objects.hash(groupsEnabled, id, name, userLockoutAction, userPasswordExpirationAction);
  }
  ...
  public String toString() {
    ...
    sb.append("class Office365Output {\n");
    
    sb.append("    groupsEnabled: ").append(toIndentedString(groupsEnabled)).append("\n");
