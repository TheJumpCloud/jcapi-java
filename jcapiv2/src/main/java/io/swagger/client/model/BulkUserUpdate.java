 ...
 */
@Schema(description = "See [V1 system user update](https://docs.jumpcloud.com/api/1.0/index.html#operation/systemusers_put) for full list of attributes.")
...
public class BulkUserUpdate {
  ...
  **/
   ...
   * @return id
  **/
  @Schema(description = "Object ID of the systemuser being updated")
  public String getId() {
    return id;
  }
