...
public class PolicyTemplateWithDetails {
  ...
  **/
   ...
   * @return configFields
  **/
  @Schema(description = "An unordered list of all the fields that can be configured for this Policy Template.")
  ...
  **/
  ...
  public PolicyTemplateWithDetails osRestrictions(List<OSRestriction> osRestrictions) {
    this.osRestrictions = osRestrictions;
    return this;
  }

  public PolicyTemplateWithDetails addOsRestrictionsItem(OSRestriction osRestrictionsItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.activation, policyTemplateWithDetails.activation) &&
        ...
        Objects.equals(this.osRestrictions, policyTemplateWithDetails.osRestrictions);
  }

  @Override
  public int hashCode() {
    return Objects.hash(activation, behavior, configFields, description, displayName, id, name, osMetaFamily, osRestrictions);
  }
