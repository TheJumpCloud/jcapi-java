...
import io.swagger.client.model.ImportUserAddress;
import io.swagger.client.model.ImportUserPhoneNumber;
...
public class ImportUser {
  ...
  public ImportUser addAddressesItem(ImportUserAddress addressesItem) {
    if (this.addresses == null) {
      this.addresses = new ArrayList<ImportUserAddress>();
    }
  ...
  **/
  ...
  public ImportUser addPhoneNumbersItem(ImportUserPhoneNumber phoneNumbersItem) {
    if (this.phoneNumbers == null) {
      this.phoneNumbers = new ArrayList<ImportUserPhoneNumber>();
    }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addresses, company, costCenter, department, displayname, email, employeeIdentifier, employeeType, firstname, id, jobTitle, lastname, location, manager, middlename, phoneNumbers, username);
  }
