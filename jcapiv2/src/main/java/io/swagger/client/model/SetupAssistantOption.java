 ...
 */
@JsonAdapter(SetupAssistantOption.Adapter.class)
public enum SetupAssistantOption {
  ...
  DEVICETODEVICEMIGRATION("deviceToDeviceMigration"),
  HOMEBUTTON("homeButton"),
  IMESSAGEANDFACETIME("imessageAndFacetime"),
  MESSAGINGACTIVATIONUSINGPHONENUMBER("messagingActivationUsingPhoneNumber"),
  MOVEFROMANDROID("moveFromAndroid"),
  PASSCODE("passcode"),
  RESTORECOMPLETE("restoreComplete"),
  SETUPCELLULAR("setupCellular"),
  SOFTWAREUPDATE("softwareUpdate"),
  UNLOCKWITHWATCH("unlockWithWatch"),
  ...
  SetupAssistantOption(String value) {
    this.value = value;
  }
  ...
  public static SetupAssistantOption fromValue(String input) {
    for (SetupAssistantOption b : SetupAssistantOption.values()) {
  ...
  public static class Adapter extends TypeAdapter<SetupAssistantOption> {
    @Override
    public void write(final JsonWriter jsonWriter, final SetupAssistantOption enumeration) throws IOException {
      jsonWriter.value(String.valueOf(enumeration.getValue()));
    }

    @Override
    public SetupAssistantOption read(final JsonReader jsonReader) throws IOException {
      Object value = jsonReader.nextString();
      return SetupAssistantOption.fromValue((String)(value));
    }
  }
}
