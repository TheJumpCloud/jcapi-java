 ...
 */
@Schema(description = "A feature represents JumpCloud functionality.")
...
public class Feature {
  ...
  public Feature name(NameEnum name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @Schema(description = "The unique identifier for this feature.")
