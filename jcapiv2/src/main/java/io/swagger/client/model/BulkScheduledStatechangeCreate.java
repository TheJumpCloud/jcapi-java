 ...
 */
@Schema(description = "Model to support bulk scheduling of a state change for one or more users")
...
public class BulkScheduledStatechangeCreate {
  @SerializedName("activation_email_override")
  private String activationEmailOverride = null;

  @SerializedName("send_activation_emails")
  private Boolean sendActivationEmails = null;
  ...
  **/
  @Schema(description = "Send the activation or welcome email to the specified email address upon activation. Can only be used with a single user_id and scheduled activation. This field will be ignored if `send_activation_emails` is explicitly set to false.")
  ...
  **/
  @Schema(description = "Set to true to send activation or welcome email(s) to each user_id upon activation. Set to false to suppress emails. Can only be used with scheduled activation(s).")
  public Boolean isSendActivationEmails() {
    return sendActivationEmails;
  }
   ...
   * @return startDate
  **/
  @Schema(required = true, description = "Date and time that scheduled action should occur")
   ...
   * @return state
  **/
  @Schema(required = true, description = "The state to move the user(s) to")
   ...
   * @return userIds
  **/
  @Schema(required = true, description = "Array of system user ids to schedule for a state change")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(activationEmailOverride, sendActivationEmails, startDate, state, userIds);
  }
