 ...
 * Filter for a field.
 */
@Schema(description = "Filter for a field.")
...
public class Filter {
  ...
  public Filter field(String field) {
   ...
   /**
   * Name of field in filter target object.
   * @return field
  **/
  @Schema(required = true, description = "Name of field in filter target object.")
   ...
   * @return operator
  **/
  @Schema(required = true, description = "Filter comparison operator.")
   ...
   * @return value
  **/
  @Schema(required = true, description = "Filter comparison value.")
  public String getValue() {
    return value;
  }
