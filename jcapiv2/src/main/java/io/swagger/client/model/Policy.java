 ...
 */
@Schema(description = "An instance of a policy template.")
...
public class Policy {
   ...
   * @return id
  **/
  @Schema(description = "ObjectId uniquely identifying a Policy.")
  public String getId() {
    return id;
  }
   ...
   * @return name
  **/
  @Schema(description = "The description for this specific Policy.")
