...
public class SystemInsightsBattery {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(amperage, charged, charging, collectionTime, condition, currentCapacity, cycleCount, designedCapacity, health, manufactureDate, manufacturer, maxCapacity, minutesToFullCharge, minutesUntilEmpty, model, percentRemaining, serialNumber, state, systemId, voltage);
  }
