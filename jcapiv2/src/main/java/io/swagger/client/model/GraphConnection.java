 ...
 */
@Schema(description = "Represents an edge between two graph objects. From can be omitted if it is clear from context.")
...
public class GraphConnection {
  ...
  public GraphConnection attributes(GraphAttributes attributes) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.attributes, graphConnection.attributes) &&
        Objects.equals(this.from, graphConnection.from) &&
