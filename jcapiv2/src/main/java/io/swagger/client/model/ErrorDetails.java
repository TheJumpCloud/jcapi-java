...
public class ErrorDetails extends Error {
  ...
  public ErrorDetails details(List<Object> details) {
    this.details = details;
    return this;
  }

  public ErrorDetails addDetailsItem(Object detailsItem) {
   ...
   * @return details
  **/
  @Schema(description = "Describes a list of objects with more detailed information of the given error. Each detail schema is according to one of the messages defined in Google's API: https://github.com/googleapis/googleapis/blob/master/google/rpc/error_details.proto")
