...
public class PolicyResult {
   ...
   * @return detail
  **/
  @Schema(description = "Details pertaining to the policy result.")
   ...
   * @return endedAt
  **/
  @Schema(description = "The end of the policy application.")
   ...
   * @return exitStatus
  **/
  @Schema(description = "The 32-bit unsigned exit status from the applying the policy.")
   ...
   * @return id
  **/
  @Schema(description = "ObjectId uniquely identifying a Policy Result.")
  public String getId() {
    return id;
  }
   ...
   * @return policyID
  **/
  @Schema(description = "ObjectId uniquely identifying the parent Policy.")
   ...
   * @return startedAt
  **/
  @Schema(description = "The start of the policy application.")
   ...
   * @return state
  **/
  @Schema(description = "Enumeration describing the state of the policy. Success, failed, or pending.")
   ...
   * @return stdErr
  **/
  @Schema(description = "The STDERR output from applying the policy.")
   ...
   * @return stdOut
  **/
  @Schema(description = "The STDOUT output from applying the policy.")
   ...
   * @return success
  **/
  @Schema(description = "True if the policy was successfully applied; false otherwise.")
   ...
   * @return systemID
  **/
  @Schema(description = "ObjectId uniquely identifying the parent System.")
