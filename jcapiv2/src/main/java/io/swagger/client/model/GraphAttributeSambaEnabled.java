 ...
 */
@Schema(description = "Enabling Samba support allows for LDAP users to authenticate to endpoints that require Samba attributes within the LDAP directory")
...
public class GraphAttributeSambaEnabled {
  @SerializedName("sambaEnabled")
  private Boolean sambaEnabled = null;

  public GraphAttributeSambaEnabled sambaEnabled(Boolean sambaEnabled) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GraphAttributeSambaEnabled graphAttributeSambaEnabled = (GraphAttributeSambaEnabled) o;
    return Objects.equals(this.sambaEnabled, graphAttributeSambaEnabled.sambaEnabled);
  }
  ...
  public String toString() {
    ...
    sb.append("class GraphAttributeSambaEnabled {\n");
