...
import io.swagger.client.model.PolicyGroup;
import io.swagger.client.model.PolicyGroupData;
...
public class PolicyGroupsApi {
    ...
    public PolicyGroupsApi() {
        this(Configuration.getDefaultApiClient());
    }

    public PolicyGroupsApi(ApiClient apiClient) {
    ...
    /**
     * Build call for groupsPolicyDelete
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call groupsPolicyDeleteCall(String id, String xOrgId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call groupsPolicyDeleteValidateBeforeCall(String id, String xOrgId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling groupsPolicyDelete(Async)");
        }
        
        com.squareup.okhttp.Call call = groupsPolicyDeleteCall(id, xOrgId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PolicyGroup groupsPolicyDelete(String id, String xOrgId) throws ApiException {
        ApiResponse<PolicyGroup> resp = groupsPolicyDeleteWithHttpInfo(id, xOrgId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PolicyGroup> groupsPolicyDeleteWithHttpInfo(String id, String xOrgId) throws ApiException {
        com.squareup.okhttp.Call call = groupsPolicyDeleteValidateBeforeCall(id, xOrgId, null, null);
        Type localVarReturnType = new TypeToken<PolicyGroup>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Delete a Policy Group (asynchronously)
     * This endpoint allows you to delete a Policy Group.  #### Sample Request &#x60;&#x60;&#x60; curl -X DELETE https://console.jumpcloud.com/api/v2/policygroups/{GroupID} \\   -H &#x27;Accept: application/json&#x27; \\   -H &#x27;Content-Type: application/json&#x27; \\   -H &#x27;x-api-key: {API_KEY}&#x27;  &#x60;&#x60;&#x60;
     * @param id ObjectID of the Policy Group. (required)
     * @param xOrgId Organization identifier that can be obtained from console settings. (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call groupsPolicyDeleteAsync(String id, String xOrgId, final ApiCallback<PolicyGroup> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = groupsPolicyDeleteValidateBeforeCall(id, xOrgId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PolicyGroup>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for groupsPolicyGet
     * @param id ObjectID of the Policy Group. (required)
     * @param xOrgId Organization identifier that can be obtained from console settings. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call groupsPolicyGetCall(String id, String xOrgId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call groupsPolicyGetValidateBeforeCall(String id, String xOrgId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling groupsPolicyGet(Async)");
        }
        
        com.squareup.okhttp.Call call = groupsPolicyGetCall(id, xOrgId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PolicyGroup groupsPolicyGet(String id, String xOrgId) throws ApiException {
        ApiResponse<PolicyGroup> resp = groupsPolicyGetWithHttpInfo(id, xOrgId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PolicyGroup> groupsPolicyGetWithHttpInfo(String id, String xOrgId) throws ApiException {
        com.squareup.okhttp.Call call = groupsPolicyGetValidateBeforeCall(id, xOrgId, null, null);
        Type localVarReturnType = new TypeToken<PolicyGroup>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * View an individual Policy Group details (asynchronously)
     * This endpoint returns the details of a Policy Group.  #### Sample Request &#x60;&#x60;&#x60; curl -X GET https://console.jumpcloud.com/api/v2/policygroups/{GroupID} \\   -H &#x27;Accept: application/json&#x27; \\   -H &#x27;Content-Type: application/json&#x27; \\   -H &#x27;x-api-key: {API_KEY}&#x27; &#x60;&#x60;&#x60;
     * @param id ObjectID of the Policy Group. (required)
     * @param xOrgId Organization identifier that can be obtained from console settings. (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call groupsPolicyGetAsync(String id, String xOrgId, final ApiCallback<PolicyGroup> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = groupsPolicyGetValidateBeforeCall(id, xOrgId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PolicyGroup>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for groupsPolicyList
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call groupsPolicyListCall(List<String> fields, List<String> filter, Integer limit, Integer skip, List<String> sort, String xOrgId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call groupsPolicyListValidateBeforeCall(List<String> fields, List<String> filter, Integer limit, Integer skip, List<String> sort, String xOrgId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = groupsPolicyListCall(fields, filter, limit, skip, sort, xOrgId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public List<PolicyGroup> groupsPolicyList(List<String> fields, List<String> filter, Integer limit, Integer skip, List<String> sort, String xOrgId) throws ApiException {
        ApiResponse<List<PolicyGroup>> resp = groupsPolicyListWithHttpInfo(fields, filter, limit, skip, sort, xOrgId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<PolicyGroup>> groupsPolicyListWithHttpInfo(List<String> fields, List<String> filter, Integer limit, Integer skip, List<String> sort, String xOrgId) throws ApiException {
        com.squareup.okhttp.Call call = groupsPolicyListValidateBeforeCall(fields, filter, limit, skip, sort, xOrgId, null, null);
        Type localVarReturnType = new TypeToken<List<PolicyGroup>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * List all Policy Groups (asynchronously)
     * This endpoint returns all Policy Groups.  Available filter fields:   - &#x60;name&#x60;   - &#x60;disabled&#x60;   - &#x60;type&#x60;  #### Sample Request &#x60;&#x60;&#x60; curl -X GET https://console.jumpcloud.com/api/v2/policygroups \\   -H &#x27;Accept: application/json&#x27; \\   -H &#x27;Content-Type: application/json&#x27; \\   -H &#x27;x-api-key: {API_KEY}&#x27; &#x60;&#x60;&#x60;
     * @param fields The comma separated fields included in the returned records. If omitted, the default list of fields will be returned.  (optional)
     * @param filter A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60; (optional)
     * @param limit The number of records to return at once. Limited to 100. (optional, default to 10)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call groupsPolicyListAsync(List<String> fields, List<String> filter, Integer limit, Integer skip, List<String> sort, String xOrgId, final ApiCallback<List<PolicyGroup>> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = groupsPolicyListValidateBeforeCall(fields, filter, limit, skip, sort, xOrgId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<List<PolicyGroup>>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for groupsPolicyPost
     * @param body  (optional)
     * @param xOrgId Organization identifier that can be obtained from console settings. (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call groupsPolicyPostCall(PolicyGroupData body, String xOrgId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call groupsPolicyPostValidateBeforeCall(PolicyGroupData body, String xOrgId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = groupsPolicyPostCall(body, xOrgId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PolicyGroup groupsPolicyPost(PolicyGroupData body, String xOrgId) throws ApiException {
        ApiResponse<PolicyGroup> resp = groupsPolicyPostWithHttpInfo(body, xOrgId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PolicyGroup> groupsPolicyPostWithHttpInfo(PolicyGroupData body, String xOrgId) throws ApiException {
        com.squareup.okhttp.Call call = groupsPolicyPostValidateBeforeCall(body, xOrgId, null, null);
        Type localVarReturnType = new TypeToken<PolicyGroup>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create a new Policy Group (asynchronously)
     * This endpoint allows you to create a new Policy Group.  #### Sample Request &#x60;&#x60;&#x60; curl -X POST https://console.jumpcloud.com/api/v2/policygroups \\   -H &#x27;Accept: application/json&#x27; \\   -H &#x27;Content-Type: application/json&#x27; \\   -H &#x27;x-api-key: {API_KEY}&#x27; \\   -d &#x27;{     \&quot;name\&quot;: \&quot;{Group_Name}\&quot;   }&#x27; &#x60;&#x60;&#x60;
     * @param body  (optional)
     * @param xOrgId Organization identifier that can be obtained from console settings. (optional)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call groupsPolicyPostAsync(PolicyGroupData body, String xOrgId, final ApiCallback<PolicyGroup> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = groupsPolicyPostValidateBeforeCall(body, xOrgId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PolicyGroup>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for groupsPolicyPut
     * @param id ObjectID of the Policy Group. (required)
     * @param body  (optional)
     * @param xOrgId Organization identifier that can be obtained from console settings. (optional)
     * @param progressListener Progress listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call groupsPolicyPutCall(String id, PolicyGroupData body, String xOrgId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call groupsPolicyPutValidateBeforeCall(String id, PolicyGroupData body, String xOrgId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new ApiException("Missing the required parameter 'id' when calling groupsPolicyPut(Async)");
        }
        
        com.squareup.okhttp.Call call = groupsPolicyPutCall(id, body, xOrgId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PolicyGroup groupsPolicyPut(String id, PolicyGroupData body, String xOrgId) throws ApiException {
        ApiResponse<PolicyGroup> resp = groupsPolicyPutWithHttpInfo(id, body, xOrgId);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PolicyGroup> groupsPolicyPutWithHttpInfo(String id, PolicyGroupData body, String xOrgId) throws ApiException {
        com.squareup.okhttp.Call call = groupsPolicyPutValidateBeforeCall(id, body, xOrgId, null, null);
        Type localVarReturnType = new TypeToken<PolicyGroup>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Update a Policy Group (asynchronously)
     * This endpoint allows you to do a full update of the Policy Group.  #### Sample Request &#x60;&#x60;&#x60; curl -X PUT https://console.jumpcloud.com/api/v2/policygroups/{Group_ID} \\   -H &#x27;Accept: application/json&#x27; \\   -H &#x27;Content-Type: application/json&#x27; \\   -H &#x27;x-api-key: {API_KEY}&#x27; \\   -d &#x27;{     \&quot;name\&quot;: \&quot;group_update\&quot;   }&#x27; &#x60;&#x60;&#x60;
     * @param id ObjectID of the Policy Group. (required)
     * @param body  (optional)
     * @param xOrgId Organization identifier that can be obtained from console settings. (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call groupsPolicyPutAsync(String id, PolicyGroupData body, String xOrgId, final ApiCallback<PolicyGroup> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = groupsPolicyPutValidateBeforeCall(id, body, xOrgId, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PolicyGroup>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
