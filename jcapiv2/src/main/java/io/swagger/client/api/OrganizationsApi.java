...
import io.swagger.client.model.OrganizationCasesResponse;
...
public class OrganizationsApi {
    ...
    /**
     * Build call for organizationsListCases
     * @param skip The offset into the records to return. (optional, default to 0)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call organizationsListCasesCall(Integer skip, List<String> sort, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call organizationsListCasesValidateBeforeCall(Integer skip, List<String> sort, Integer limit, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = organizationsListCasesCall(skip, sort, limit, progressListener, progressRequestListener);
        return call;
     ...
     * @param sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending.  (optional)
     * @param limit The number of records to return at once. Limited to 100. (optional, default to 10)
     * @return OrganizationCasesResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public OrganizationCasesResponse organizationsListCases(Integer skip, List<String> sort, Integer limit) throws ApiException {
        ApiResponse<OrganizationCasesResponse> resp = organizationsListCasesWithHttpInfo(skip, sort, limit);
        return resp.getData();
    }
     ...
     * @param sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending.  (optional)
     * @param limit The number of records to return at once. Limited to 100. (optional, default to 10)
     * @return ApiResponse&lt;OrganizationCasesResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<OrganizationCasesResponse> organizationsListCasesWithHttpInfo(Integer skip, List<String> sort, Integer limit) throws ApiException {
        com.squareup.okhttp.Call call = organizationsListCasesValidateBeforeCall(skip, sort, limit, null, null);
        Type localVarReturnType = new TypeToken<OrganizationCasesResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get all cases (Support/Feature requests) for organization (asynchronously)
     * This endpoint returns the cases (Support/Feature requests) for the organization
     * @param skip The offset into the records to return. (optional, default to 0)
     * @param sort The comma separated fields used to sort the collection. Default sort is ascending, prefix with &#x60;-&#x60; to sort descending.  (optional)
     * @param limit The number of records to return at once. Limited to 100. (optional, default to 10)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call organizationsListCasesAsync(Integer skip, List<String> sort, Integer limit, final ApiCallback<OrganizationCasesResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = organizationsListCasesValidateBeforeCall(skip, sort, limit, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<OrganizationCasesResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
