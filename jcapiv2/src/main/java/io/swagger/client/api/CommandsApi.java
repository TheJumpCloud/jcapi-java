...
import io.swagger.client.model.QueuedCommandList;
...
public class CommandsApi {
    ...
    /**
     * Build call for commandsCancelQueuedCommandsByWorkflowInstanceId
     ...
     */
    public com.squareup.okhttp.Call commandsCancelQueuedCommandsByWorkflowInstanceIdCall(String workflowInstanceId, String xOrgId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/commandqueue/{workflow_instance_id}"
            .replaceAll("\\{" + "workflow_instance_id" + "\\}", apiClient.escapeString(workflowInstanceId.toString()));
    ...
    private com.squareup.okhttp.Call commandsCancelQueuedCommandsByWorkflowInstanceIdValidateBeforeCall(String workflowInstanceId, String xOrgId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'workflowInstanceId' is set
        if (workflowInstanceId == null) {
            throw new ApiException("Missing the required parameter 'workflowInstanceId' when calling commandsCancelQueuedCommandsByWorkflowInstanceId(Async)");
        }
        
        com.squareup.okhttp.Call call = commandsCancelQueuedCommandsByWorkflowInstanceIdCall(workflowInstanceId, xOrgId, progressListener, progressRequestListener);
        return call;
     ...
     */
    public void commandsCancelQueuedCommandsByWorkflowInstanceId(String workflowInstanceId, String xOrgId) throws ApiException {
        commandsCancelQueuedCommandsByWorkflowInstanceIdWithHttpInfo(workflowInstanceId, xOrgId);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> commandsCancelQueuedCommandsByWorkflowInstanceIdWithHttpInfo(String workflowInstanceId, String xOrgId) throws ApiException {
        com.squareup.okhttp.Call call = commandsCancelQueuedCommandsByWorkflowInstanceIdValidateBeforeCall(workflowInstanceId, xOrgId, null, null);
        return apiClient.execute(call);
    }

    /**
     * Cancel all queued commands for an organization by workflow instance Id (asynchronously)
     * This endpoint allows all queued commands for one workflow instance to be canceled.  #### Sample Request &#x60;&#x60;&#x60;  curl -X DELETE https://console.jumpcloud.com/api/v2/commandqueue/{workflow_instance_id} \\   -H &#x27;accept: application/json&#x27; \\   -H &#x27;content-type: application/json&#x27; \\   -H &#x27;x-api-key: {API_KEY}&#x27; &#x60;&#x60;&#x60;
     * @param workflowInstanceId Workflow instance Id of the queued commands to cancel. (required)
     * @param xOrgId Organization identifier that can be obtained from console settings. (optional)
     ...
     */
    public com.squareup.okhttp.Call commandsCancelQueuedCommandsByWorkflowInstanceIdAsync(String workflowInstanceId, String xOrgId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = commandsCancelQueuedCommandsByWorkflowInstanceIdValidateBeforeCall(workflowInstanceId, xOrgId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     * Build call for commandsGetQueuedCommandsByWorkflow
     * @param xOrgId Organization identifier that can be obtained from console settings. (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call commandsGetQueuedCommandsByWorkflowCall(String xOrgId, Integer limit, List<String> filter, Integer skip, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call commandsGetQueuedCommandsByWorkflowValidateBeforeCall(String xOrgId, Integer limit, List<String> filter, Integer skip, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        com.squareup.okhttp.Call call = commandsGetQueuedCommandsByWorkflowCall(xOrgId, limit, filter, skip, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public QueuedCommandList commandsGetQueuedCommandsByWorkflow(String xOrgId, Integer limit, List<String> filter, Integer skip) throws ApiException {
        ApiResponse<QueuedCommandList> resp = commandsGetQueuedCommandsByWorkflowWithHttpInfo(xOrgId, limit, filter, skip);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<QueuedCommandList> commandsGetQueuedCommandsByWorkflowWithHttpInfo(String xOrgId, Integer limit, List<String> filter, Integer skip) throws ApiException {
        com.squareup.okhttp.Call call = commandsGetQueuedCommandsByWorkflowValidateBeforeCall(xOrgId, limit, filter, skip, null, null);
        Type localVarReturnType = new TypeToken<QueuedCommandList>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Fetch the queued Commands for an Organization (asynchronously)
     * This endpoint will return all queued Commands for an Organization.  Each element will contain the workflow ID, the command name, the launch type (e.g. manual, triggered, or scheduled), the target OS, the number of assigned devices, and the number of pending devices that have not yet ran the command.  #### Sample Request &#x60;&#x60;&#x60; curl -X GET https://console.jumpcloud.com/api/v2/queuedcommand/workflows \\   -H &#x27;accept: application/json&#x27; \\   -H &#x27;content-type: application/json&#x27; \\   -H &#x27;x-api-key: {API_KEY}&#x27; &#x60;&#x60;&#x60;
     * @param xOrgId Organization identifier that can be obtained from console settings. (optional)
     * @param limit  (optional, default to 10)
     * @param filter A filter to apply to the query.  **Filter structure**: &#x60;&lt;field&gt;:&lt;operator&gt;:&lt;value&gt;&#x60;.  **field** &#x3D; Populate with a valid field from an endpoint response.  **operator** &#x3D;  Supported operators are: eq, ne, gt, ge, lt, le, between, search, in. _Note: v1 operators differ from v2 operators._  **value** &#x3D; Populate with the value you want to search for. Is case sensitive. Supports wild cards.  **EX:** &#x60;GET /api/v2/groups?filter&#x3D;name:eq:Test+Group&#x60; (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call commandsGetQueuedCommandsByWorkflowAsync(String xOrgId, Integer limit, List<String> filter, Integer skip, final ApiCallback<QueuedCommandList> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = commandsGetQueuedCommandsByWorkflowValidateBeforeCall(xOrgId, limit, filter, skip, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<QueuedCommandList>(){}.getType();
