...
public class Commandfilereturn {
  ...
  private List<CommandfilereturnResults> results = null;

  @SerializedName("totalCount")
  private Integer totalCount = null;

  public Commandfilereturn results(List<CommandfilereturnResults> results) {
    this.results = results;
    return this;
  }

  public Commandfilereturn addResultsItem(CommandfilereturnResults resultsItem) {
    if (this.results == null) {
      this.results = new ArrayList<CommandfilereturnResults>();
    }
  ...
  **/
  @Schema(description = "")
  public List<CommandfilereturnResults> getResults() {
    return results;
  }

  public void setResults(List<CommandfilereturnResults> results) {
    this.results = results;
  }
   ...
   * @return totalCount
  **/
  @Schema(description = "The total number of commands files")
