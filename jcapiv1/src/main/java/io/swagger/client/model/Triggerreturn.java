...
public class Triggerreturn {
  ...
  private List<String> triggered = null;

  public Triggerreturn triggered(List<String> triggered) {
    this.triggered = triggered;
    return this;
  }

  public Triggerreturn addTriggeredItem(String triggeredItem) {
    if (this.triggered == null) {
      this.triggered = new ArrayList<String>();
    }
  ...
  **/
  ...
  public void setTriggered(List<String> triggered) {
    this.triggered = triggered;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Triggerreturn triggerreturn = (Triggerreturn) o;
    return Objects.equals(this.triggered, triggerreturn.triggered);
  }

  @Override
  public int hashCode() {
    return Objects.hash(triggered);
  }
