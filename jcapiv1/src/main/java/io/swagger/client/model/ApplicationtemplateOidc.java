...
public class ApplicationtemplateOidc {
  /**
  ...
  public ApplicationtemplateOidc grantTypes(List<GrantTypesEnum> grantTypes) {
    this.grantTypes = grantTypes;
    return this;
  }

  public ApplicationtemplateOidc addGrantTypesItem(GrantTypesEnum grantTypesItem) {
    if (this.grantTypes == null) {
      this.grantTypes = new ArrayList<GrantTypesEnum>();
    }
   ...
   * @return grantTypes
  **/
  @Schema(description = "The grant types allowed. Currently only authorization_code is allowed.")
  ...
  public ApplicationtemplateOidc redirectUris(List<String> redirectUris) {
    this.redirectUris = redirectUris;
    return this;
  }

  public ApplicationtemplateOidc addRedirectUrisItem(String redirectUrisItem) {
   ...
   * @return redirectUris
  **/
  @Schema(description = "List of allowed redirectUris")
  ...
  public ApplicationtemplateOidc ssoUrl(String ssoUrl) {
    this.ssoUrl = ssoUrl;
    return this;
  }
   ...
   * @return ssoUrl
  **/
  @Schema(description = "The relying party url to trigger an oidc login.")
  ...
  public ApplicationtemplateOidc tokenEndpointAuthMethod(TokenEndpointAuthMethodEnum tokenEndpointAuthMethod) {
  ...
  **/
  @Schema(description = "Method that the client uses to authenticate when requesting a token. If 'none', then the client must use PKCE. If 'client_secret_post', then the secret is passed in the post body when requesting the token.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ApplicationtemplateOidc applicationtemplateOidc = (ApplicationtemplateOidc) o;
    return Objects.equals(this.grantTypes, applicationtemplateOidc.grantTypes) &&
        Objects.equals(this.redirectUris, applicationtemplateOidc.redirectUris) &&
        Objects.equals(this.ssoUrl, applicationtemplateOidc.ssoUrl) &&
        Objects.equals(this.tokenEndpointAuthMethod, applicationtemplateOidc.tokenEndpointAuthMethod);
  }

  @Override
  public int hashCode() {
    return Objects.hash(grantTypes, redirectUris, ssoUrl, tokenEndpointAuthMethod);
  }
  ...
  public String toString() {
    ...
    sb.append("class ApplicationtemplateOidc {\n");
