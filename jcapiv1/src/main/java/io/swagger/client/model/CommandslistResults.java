...
public class CommandslistResults {
  ...
  public CommandslistResults _id(String _id) {
    this._id = _id;
    return this;
  }
  ...
  **/
   ...
   * @return command
  **/
  @Schema(description = "The Command to execute.")
   ...
   * @return commandType
  **/
  @Schema(description = "The Command OS.")
   ...
   * @return launchType
  **/
  @Schema(description = "How the Command is executed.")
  ...
  **/
   ...
   * @return trigger
  **/
  @Schema(description = "Trigger to execute command.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this._id, commandslistResults._id) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(_id, command, commandType, launchType, listensTo, name, organization, schedule, scheduleRepeatType, trigger);
  }
