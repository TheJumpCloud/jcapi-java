...
public class ManagedServiceProviderApiTest {
     ...
     */
    @Test
    public void adminTotpresetBeginTest() throws Exception {
        String id = null;
        api.adminTotpresetBegin(id);
    ...
    public void organizationListTest() throws Exception {
        ...
        Integer skip = null;
        String sort = null;
        Organizationslist response = api.organizationList(fields, filter, limit, search, skip, sort);
    ...
    public void usersPutTest() throws Exception {
        ...
        Userput body = null;
        String xOrgId = null;
        Userreturn response = api.usersPut(id, body, xOrgId);
     ...
     */
    @Test
    public void usersReactivateGetTest() throws Exception {
        String id = null;
        api.usersReactivateGet(id);
