...
public class OrganizationsApiTest {
     ...
     */
    @Test
    public void organizationPutTest() throws Exception {
        String id = null;
        OrganizationsIdBody body = null;
        Organization response = api.organizationPut(id, body);
     ...
     */
    @Test
    public void organizationsGetTest() throws Exception {
        String id = null;
        String fields = null;
        String filter = null;
        Organization response = api.organizationsGet(id, fields, filter);
