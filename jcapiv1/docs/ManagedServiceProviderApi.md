...
try {
    ...
    System.err.println("Exception when calling ManagedServiceProviderApi#adminTotpresetBegin");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling ManagedServiceProviderApi#organizationList");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling ManagedServiceProviderApi#usersPut");
    e.printStackTrace();
}
```
...
try {
    ...
    System.err.println("Exception when calling ManagedServiceProviderApi#usersReactivateGet");
    e.printStackTrace();
}
```
